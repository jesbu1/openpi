...
class LeRobotLiberoDataConfig(DataConfigFactory):
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        elif self.obs_type == "path_masked_centered":
            obs_key = "masked_path_centered_image"
        else:
...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="jesbu1/libero_test_lerobot_pathmask_rdp",
            base_config=DataConfig(
                local_files_only=True,  # Set to True for local-only datasets.
                prompt_from_task=True,
            ),
    ...
    TrainConfig(
        name="pi0_libero_low_mem_finetune_path_debug_no_proprio",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="jesbu1/libero_test_lerobot_pathmask_rdp",
    ...
    TrainConfig(
        name="pi0_libero_low_mem_finetune_path_no_proprio",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="jesbu1/libero_90_lerobot_pathmask_rdp",
    ...
    TrainConfig(
        name="pi0_libero_low_mem_finetune_masked_no_proprio",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="jesbu1/libero_90_lerobot_pathmask_rdp",
    ...
    TrainConfig(
        name="pi0_libero_low_mem_finetune_path_masked_no_proprio",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="jesbu1/libero_90_lerobot_pathmask_rdp",
    ...
    TrainConfig(
        name="pi0_libero_low_mem_finetune_fullpath_path",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
        ...
        validation_data=LeRobotLiberoDataConfig(
            repo_id="jesbu1/libero_test_lerobot_pathmask_rdp_full_path_mask",  # Your validation dataset
            base_config=DataConfig(
                local_files_only=True,
                prompt_from_task=True,
            ),
    ...
    TrainConfig(
        name="pi0_libero_low_mem_finetune_no_proprio",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="jesbu1/libero_90_lerobot_pathmask_rdp_full_path_mask",
    ...
    TrainConfig(
        name="pi0_libero_low_mem_finetune_fullpath_path_no_proprio",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="jesbu1/libero_90_lerobot_pathmask_rdp_full_path_mask",
    ...
    TrainConfig(
        name="pi0_libero_low_mem_finetune_fullpath_path_masked",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="jesbu1/libero_90_lerobot_pathmask_rdp_full_path_mask",
    ...
    TrainConfig(
        name="pi0_libero_low_mem_finetune_vlm_path_masked",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            # repo_id="jesbu1/libero_90_lerobot_pathmask_rdp_full_path_mask",
    ...
    TrainConfig(
        name="pi0_libero_low_mem_finetune_vlm_path_masked_centered",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            # repo_id="jesbu1/libero_90_lerobot_pathmask_rdp_full_path_mask",
    ...
    TrainConfig(
        name="pi0_libero_low_mem_finetune_fullpath_path_masked_no_proprio",
        # Here is an example of loading a pi0 model for LoRA fine-tuning.
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotLiberoDataConfig(
            repo_id="jesbu1/libero_90_lerobot_pathmask_rdp_full_path_mask",
